...
export const btnBaseClass = 'relative font-barlow-condensed font-bold text-[13.5px] tracking-[0.06em] uppercase cursor-pointer border-2 rounded-[7px] transition-all duration-[260ms] ease-out inline-flex items-center gap-[9px] p-[12px_24px] max-[480px]:p-[11px_20px] max-[480px]:text-[13px] max-[390px]:p-[10px_18px] max-[390px]:text-[12.5px] max-[320px]:p-[9px_16px] max-[320px]:text-[12px] max-[320px]:gap-[6px] after:content-["→"] after:inline-block after:transition-transform after:duration-300 after:ease-out hover:after:translate-x-[4px] active:scale-[0.97]';
...
export const cabinViewerClass = `w-full min-w-0 relative h-[74vh] [mask-image:radial-gradient(112%_112%_at_50%_45%,#000_52%,transparent_90%)] [-webkit-mask-image:radial-gradient(112%_112%_at_50%_45%,#000_52%,transparent_90%)] flex-1 basis-[46%] min-w-[280px] max-w-[820px] ${mh820}h-[min(70vh,calc(100vh-150px))] ${mh660}h-[min(64vh,calc(100vh-140px))]`;
...
export const pageHeroCopyClass = 'relative z-1 max-w-[clamp(560px,58vw,820px)] pt-[78px] max-[900px]:pt-[100px]';
export const pageHeroH1Class = `${h1Class} [font-size:clamp(34px,7.8vw,74px)] mt-[16px]`;
export const pageHeroSubClass = 'text-[18px] text-brand-off max-w-[clamp(380px,42vw,560px)] mt-[22px]';
...
// ---- Industries page ----
export const pageHeroFlexClass = 'flex items-start justify-between gap-[clamp(20px,1.8vw,24px)] max-[900px]:flex-col max-[900px]:items-stretch max-[900px]:gap-[8px]';
...
export const industriesHeroVisualClass = 'relative z-1 flex-none pointer-events-auto w-[clamp(460px,42vw,680px)] mt-[78px] max-[900px]:mx-auto max-[900px]:mt-[26px] max-[900px]:w-[min(94vw,440px)]';
export const industriesHeroFrameClass = "relative aspect-[5/4]";
