...
export const btnBaseClass = 'font-barlow-condensed font-bold text-[15px] tracking-[0.08em] uppercase cursor-pointer border-2 border-transparent transition-all duration-[220ms] ease-in-out inline-flex items-center gap-[10px] p-[16px_30px] max-[480px]:p-[14px_22px] max-[480px]:text-[14px] max-[390px]:p-[13px_18px] max-[390px]:text-[13px] max-[320px]:p-[12px_16px] max-[320px]:text-[12px] max-[320px]:gap-[6px]';
export const btnPrimaryClass = `${btnBaseClass} bg-brand-red text-brand-white hover:bg-brand-red-dark hover:-translate-y-0.5`;
export const btnGhostClass = `${btnBaseClass} border-brand-white text-brand-white bg-transparent hover:bg-brand-white hover:text-brand-black`;
...
export const cardBtnGhostClass = `${btnBaseClass} border-[#111] text-[#111] bg-transparent hover:bg-[#111] hover:text-[#f7f7f5]`;
